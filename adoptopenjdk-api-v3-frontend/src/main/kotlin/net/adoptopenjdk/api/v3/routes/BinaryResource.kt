...
class BinaryResource {
    ...
    @GET
    @Path("{release_type}/{feature_version}/{os}/{arch}/{release_name}/{image_type}/{jvm_impl}/{heap_size}/{vendor}")
    ...
    fun returnBinary(
            ...
            @Parameter(name = "release_name", description = "Release e.g latest, jdk-11.0.4+11, jdk8u172-b00-201807161800", required = true,
