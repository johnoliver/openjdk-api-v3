            ...
            RestAssured.given()
                    ...
                    .body(object : TypeSafeMatcher<String>() {
                        ...
                        override fun matchesSafely(p0: String?): Boolean {
                            val stats = JsonMapper.mapper.readValue(p0, List::class.java)
                            return stats.size == 3 &&
                                    (stats[0] as Map<String, *>).get("total") == 10 &&
                                    (stats[0] as Map<String, *>).get("daily") == 2 &&
                                    (stats[1] as Map<String, *>).get("total") == 46 &&
                                    (stats[1] as Map<String, *>).get("daily") == 7 &&
                                    (stats[2] as Map<String, *>).get("total") == 90 &&
                                    (stats[2] as Map<String, *>).get("daily") == 11
                        }
                    })
        }
    }
