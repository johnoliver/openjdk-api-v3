                    ...
                    .body(object : TypeSafeMatcher<String>() {
                        ...
                        override fun matchesSafely(p0: String?): Boolean {
                            ...
                            return stats.size == 4 &&
                                    ...
                                    (stats[3] as Map<String, *>).get("total") == 1400 &&
                                    (stats[3] as Map<String, *>).get("monthly") == 300
                        }
                    })
        }
    }
                    ...
                    .body(object : TypeSafeMatcher<String>() {
                        ...
                        override fun matchesSafely(p0: String?): Boolean {
                            ...
                            return stats.size == 3 &&
                                    ...
                                    (stats[2] as Map<String, *>).get("total") == 600 &&
                                    (stats[2] as Map<String, *>).get("monthly") == -500
                        }
                    })
        }
    }
                    ...
                    .body(object : TypeSafeMatcher<String>() {
                        ...
                        override fun matchesSafely(p0: String?): Boolean {
                            ...
                            return stats.size == 3 &&
                                    ...
                                    (stats[2] as Map<String, *>).get("total") == 1200 &&
                                    (stats[2] as Map<String, *>).get("monthly") == 750
                        }
                    })
        }
    }
                    ...
                    .body(object : TypeSafeMatcher<String>() {
                        ...
                        override fun matchesSafely(p0: String?): Boolean {
                            ...
                            return stats.size == 3 &&
                                    ...
                                    (stats[2] as Map<String, *>).get("total") == 600 &&
                                    (stats[2] as Map<String, *>).get("monthly") == 290
                        }
                    })
        }
    }
